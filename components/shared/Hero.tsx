    ...
    <section>
      ...
      >
        <div className="flex items-center relative gap-4 md:gap-6">
          ...
          <Image
            ...
            height={42}
          />
          <h3 className=" text-sm md:text-base p-1 md:px-7 md:py-2.5 2xl:p-3  2xl:px-7 border   -rotate-12 text-[#7268FA] rounded-xl border-slate- dark:border-none dark:bg-slate-800 2xl:text-lg">
            App Dev
          </h3>
          <h3 className=" text-sm md:text-base p-1 md:px-7 md:py-2.5 2xl:p-3  2xl:px-7 border   rotate-12 text-[#7268FA] rounded-xl border-slate- dark:border-none dark:bg-slate-800 2xl:text-lg">
            UI | UX
      ...
      <section className="flex flex-col items-center gap-6 ">
        ...
        <div className="flex  items-center justify-center gap-3 w-full  md:gap-8 px-12">
          <button className=" bg-gradient-to-r text-xs  md:w-48 flex-grow md:flex-grow-0 from-slate-200/40 to-[#E2E2E2]  dark:from-slate-800 dark:to-slate-800 md:text-base 2xl:text-lg text-[#4F4F4F] dark:text-slate-400 font-semibold rounded-[1.25rem] px-5 2xl:px-8 py-[1.1rem]  ">
            Contact Us
          </button>
          <button className=" bg-white dark:bg-transparent flex-grow md:flex-grow-0 md:w-48 text-xs md:text-base 2xl:text-lg text-slate-800 dark:text-slate-300 font-semibold rounded-[1.25rem] px-5 2xl:px-8 py-[1rem]  border-2 border-slate-800">
            Book Meeting
          </button>
        </div>
        {/* <HeroBentoGrid /> */}
